                        ...
                        <div class="row m-l-0 m-r-0">
                            ...
                            <div class="col-sm-8">
                                <div class="card-block">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <p class="m-b-10 f-w-600">تاریخ ثبت نام</p>
                                            <h6 class="text-muted f-w-400">{{\Hekmatinasser\Verta\Facades\Verta::instance($user->created_at)}}</h6>
                                        </div>

                                        <div class="col-sm-6">
                                            <p class="m-b-10 f-w-600"> امتیازات شما</p>
