        ...
        <tr>
            <td>
                <div class="power_controls">
                    ...
                    <br/>
                    <img id="spin_button" src="/js/spin/spin_off.png" alt="Spin" onClick="startSpin();"/>
                    <br/><br/>
...
<script>
    ...
    function alertPrize(indicatedSegment) {
        ...
        axios.get('/api/spin/' + indicatedSegment.text).then(response => console.log(response)).catch(error => console.log(error));
